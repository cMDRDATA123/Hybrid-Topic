...
The amounts follow the standard rates of $0.40 input / $1.60 output per million tokens for [GPT-4.1 mini](https://developers.openai.com/api/docs/models/gpt-4.1-mini), and $0.20 input / $1.20 output for [GPT-5.6 Luna](https://developers.openai.com/api/docs/models/gpt-5.6-luna), as published after the July 2026 Luna price reduction and applicable to the September 2026 runs. We charge every recorded input token at the ordinary uncached input rate. This hypothetical no-cache-pricing comparison omits cache-read discounts and the cache-write premium. The [cost audit](results/api_cost_audit_20260923.md) records both scenarios. These estimates are not invoices and exclude local embedding, graph computation, and other development runs. They describe the collection sizes and configurations used here. Full cost comparisons across systems would require the same data, hardware, and pricing assumptions.
